...
---------------------------------------------------------------------------------------------------------------------
max7301		Microchip		 20/28			SPI					INT
---------------------------------------------------------------------------------------------------------------------
Version history:
...
class max7301 : public gpio_expander
{

public:
	max7301(const uint8_t csPin,const uint8_t haenAdrs);//any pin,0x20....0x27
	max7301(const uint8_t csPin,const uint8_t haenAdrs,uint32_t spispeed);//for SPI transactions
